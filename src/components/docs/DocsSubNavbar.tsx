...
// Categories/Guides mapping for the documentation sub-navbar horizontal tabs
const sections = [
...
/**
 * DocsSubNavbar is the secondary horizontal sub-navigation tabs component.
 * It allows clicking through major documentation sections (Getting Started, Developers Guide,
 * Non-Developers Guide, General Contact Form, video Tutorials, and API Status reports).
 */
const DocsSubNavbar = () => {
  return (
